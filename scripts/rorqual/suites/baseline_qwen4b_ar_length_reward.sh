# Rorqual exp C — Qwen3-4B: length-penalised GRPO reward + AR logging/checkpoints; intrinsic off in policy.
#
# Training hyperparameters: examples/research/rorqual/baseline_ar_length_reward_math12k.yaml
...
export BASE_CONFIG="${BASE_CONFIG:-examples/research/rorqual/baseline_ar_length_reward_math12k.yaml}"
...
export RUN_ID="${RUN_ID:-rorqual_baseline_ar_length_reward_n${TRAINER_NNODES:-1}g${TRAINER_N_GPUS_PER_NODE:-4}_$(date +%Y%m%d_%H%M%S)}"
